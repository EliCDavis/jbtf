...
func TestEncoder(t *testing.T) {
	...
	// ACT ====================================================================
	aData, aErr := encoder.Marshal(&embeddedBinaryStruct{Serializable: &jbtfSerializableStruct{data: 12345}})
	bData, bErr := encoder.Marshal(&embeddedBinaryStruct{Serializable: &jbtfSerializableStruct{data: 67890}})
